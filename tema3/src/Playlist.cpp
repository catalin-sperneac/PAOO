...
void Playlist::ensureCapacity(int minCapacity)
{
    ...
    unique_ptr<Song[]> newArray = make_unique<Song[]>(newCap);
...
Playlist::Playlist(const Playlist& other)
        :name(other.name+" (copie)"), songs(make_unique<Song[]>(other.capacity)), count(other.count), capacity(other.capacity)
{
...
Playlist::Playlist(Playlist&& other) noexcept
        :songs(move(other.songs)), count(other.count), capacity(other.capacity), name(move(other.name))
{
...
Playlist& Playlist::operator=(const Playlist& other)
{
    ...
    songs = make_unique<Song[]>(other.capacity);
